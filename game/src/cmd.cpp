...
// ACMD(do_set_developer_rang);
// ACMD(do_rem_developer_rang);
// ACMD(do_set_organize_rang);
...
ACMD(do_set_teamleitung_rang);
ACMD(do_rem_teamleitung_rang);
ACMD(do_set_sgm_rang);
ACMD(do_rem_sgm_rang);
ACMD(do_set_dev_tec_rang);
ACMD(do_rem_dev_tec_rang);
ACMD(do_set_sup_rang);
ACMD(do_rem_sup_rang);
ACMD(do_set_se_rang);
ACMD(do_rem_se_rang);
...
ACMD(do_inputall)
{
	ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "명령어를 모두 입력하세요."));
}
...
struct command_info cmd_info[] =
{
	...
	{ "book",		do_book,		0,			POS_DEAD,	GM_HIGH_WIZARD  },
	...
	{ "refine_rod",	do_refine_rod,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	// END_OF_REFINE_ROD_HACK_BUG_FIX

	// REFINE_PICK
	{ "refine_pick",	do_refine_pick,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "max_pick",	do_max_pick,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	// END_OF_REFINE_PICK

	{ "fish_simul",	do_fishing_simul,	0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "invisible",	do_invisibility,	0,			POS_DEAD,	GM_LOW_WIZARD	},
	{ "qf",		do_qf,			0,			POS_DEAD,	GM_HIGH_WIZARD	},
...
//	{ "몬스터보여줘",	do_monsterlog,		0,			POS_DEAD,	GM_LOW_WIZARD	},//@fixme105
	...
	{ "socketitem",	do_socket_item,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "saveati",	do_save_attribute_to_image, 0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "player_unban",	do_player_unban,	0,			POS_DEAD,	GM_HIGH_WIZARD },
	...
	{ "change_attr",	do_change_attr,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "add_attr",	do_add_attr,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "add_socket",	do_add_socket,		0,			POS_DEAD,	GM_HIGH_WIZARD	},

	{ "user_horse_ride",	do_user_horse_ride,		0,		POS_FISHING,	GM_PLAYER	},
	{ "user_horse_or_mount_ride",	do_user_horse_or_mount_ride,		0,		POS_DEAD,	GM_PLAYER	},
	{ "new_user_horse_or_mount_ride",	do_new_user_horse_or_mount_ride,		0,		POS_DEAD,	GM_PLAYER	},
	{ "announcement",	do_announcement,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "user_buy_switcher",	do_user_buy_switcher,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_open_all_giftbox",	do_user_open_all_giftbox,		0,		POS_DEAD,	GM_PLAYER	},
	// Battlezone Commands
	{ "user_enter_battlezone",	do_user_enter_battlezone,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_request_leave_battlezone",	do_user_request_leave_battlezone,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_quick_exit_battlezone",	do_user_quick_exit_battlezone,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_normal_leave_battlezone",	do_user_normal_leave_battlezone,		0,		POS_DEAD,	GM_PLAYER	},
	{ "user_final_leave_battlezone",	do_user_final_leave_battlezone,		0,		POS_DEAD,	GM_PLAYER	},
	...
	{ "set_sl_rank",			do_set_serverleitung_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "rem_sl_rank",			do_rem_serverleitung_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},

	{ "set_tl_rank",			do_set_teamleitung_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "rem_tl_rank",			do_rem_teamleitung_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},

	{ "set_sgm_rank",			do_set_sgm_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "rem_sgm_rank",			do_rem_sgm_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	
	{ "set_dev_rank",			do_set_dev_tec_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "rem_dev_rank",			do_rem_dev_tec_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	
	{ "set_sup_rank",			do_set_sup_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "rem_sup_rank",			do_rem_sup_rang,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "map_event",	do_map_event,	0,	POS_DEAD,	GM_PLAYER	},
	...
	{ "costvisible",        do_costvisible,         0,  POS_DEAD,   GM_PLAYER   },
	{ "cube",				do_cube,				0,	POS_DEAD,	GM_PLAYER	},
	{ "siege",				do_siege,				0,	POS_DEAD,	GM_LOW_WIZARD	},
	{ "temp",				do_temp,				0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "frog",				do_frog,				0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "check_mmoney",		do_check_monarch_money,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "reset_subskill",		do_reset_subskill,		0,	POS_DEAD,	GM_HIGH_WIZARD },
	{ "flush",				do_flush,				0,	POS_DEAD,	GM_HIGH_WIZARD },
...
//	{ "주사위",				do_dice,				0,	POS_DEAD,	GM_PLAYER		},//@fixme105
	{ "special_item",			do_special_item,	0,	POS_DEAD,	GM_HIGH_WIZARD		},
...
#endif
	{ "\n",		NULL,			0,			POS_DEAD,	GM_HIGH_WIZARD	}  /* 반드시 이 것이 마지막이어야 한다. */
};
...
void interpret_command(LPCHARACTER ch, const char * argument, size_t len)
{
	...
	if (ch->GetPosition() < cmd_info[icmd].minimum_position)
	{
		...
		{
			case POS_MOUNTING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "탄 상태에서는 할 수 없습니다."));
				break;

			case POS_DEAD:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "쓰러진 상태에서는 할 수 없습니다."));
				break;

			case POS_SLEEPING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "꿈속에서 어떻게요?"));
				break;

			case POS_RESTING:
			case POS_SITTING:
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "먼저 일어 나세요."));
				break;
				/*
				   case POS_FIGHTING:
				   ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT_CONVERT_LANGUAGE(ch->GetLanguage(), "목숨을 걸고 전투 중 입니다. 집중 하세요."));
				   break;
				 */
			default:
