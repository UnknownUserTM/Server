...
void SECTREE_MANAGER::InsertNPCPosition(long lMapIndex, BYTE bType, const char* szName, long x, long y, DWORD dwVnum)
{
	m_mapNPCPosition[lMapIndex].push_back(npc_info(bType, szName, x, y, dwVnum));
}
