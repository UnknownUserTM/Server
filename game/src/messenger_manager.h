...
class MessengerManager : public singleton<MessengerManager>
{
	...
	public:
		...
		#ifdef ENABLE_MESSENGER_BLOCK
		void	__AddToBlockList(keyA account, keyA companion);	// 실제 m_Relation, m_InverseRelation 수정하는 메소드
		...
		void	__RemoveFromBlockList(keyA account, keyA companion); // 실제 m_Relation, m_InverseRelation 수정하는 메소드
