...
enum EWearPositions
{
	...
	WEAR_COSTUME_WEAPON, // 33 : weapon costume
...
enum EApplyTypes
{
	...
	APPLY_ATTBONUS_STONE,		//92
	APPLY_ATTBONUS_BOSS,		//93
...
enum SPECIAL_EFFECT
{
	...
	SE_EQUIP_HERO_MEDAL,
	SE_EQUIP_DEADLY_MIGHT_RING,
	SE_EQUIP_LOLLI,
	SE_EQUIP_HALFMOON_RING,
