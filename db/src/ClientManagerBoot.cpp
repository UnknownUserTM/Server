...
bool CClientManager::InitializeRefineTable()
{
	...
	while ((data = mysql_fetch_row(pRes->pSQLResult)))
	{
		...
		sys_log(0, "REFINE: id %ld cost %d prob %d mat0 %lu cnt0 %d, mat1 %lu cnt1 %d, mat2 %lu cnt2 %d, mat3 %lu cnt3 %d, mat4 %lu cnt4 %d", 
			prt->id, prt->cost, prt->prob,
			prt->materials[0].vnum, prt->materials[0].count,
			prt->materials[1].vnum, prt->materials[1].count,
			prt->materials[2].vnum, prt->materials[2].count,
			prt->materials[3].vnum, prt->materials[3].count,
			prt->materials[4].vnum, prt->materials[4].count );
...
enum IProtoT
{
	...
	applytype0, applyvalue0, applytype1, applyvalue1, applytype2, applyvalue2,
	applytype3, applyvalue3, applytype4, applyvalue4,
	value0, value1, value2, value3, value4, value5
